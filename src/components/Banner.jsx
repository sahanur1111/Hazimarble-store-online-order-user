...
import bannerImg3 from "/images/home/banner3.png";
      ...
      >
          ...
          <div className="flex flex-col md:flex-row items-center justify-around -mt-14 gap-4">
            <div className="bg-white px-3 py-2 rounded-2xl flex items-center gap-3 shadow-sm w-64">
              ...
              <div className="font-medium mb-1">
                <h5 className={`${isDarkMode ? "text-gray" : ""}`}>
                  Wash Basin
                </h5>
        ...
        <div className="md:w-1/2 space-y-7 px-4">
          ...
          <p className="text-xl text-[#4A4A4A]">
            <TypeAnimation
              sequence={[
                "Discover quality marble, pipes, basins, and tiles for your home at our store. Elevate your space with our diverse, stylish selections.",
              ]}
              speed={10}
              loop
            />
