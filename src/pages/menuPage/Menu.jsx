...
const Menu = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch("https://marble-store-app.onrender.com/menu");
    ...
    <div>
        ...
        <div className="py-48 flex flex-col items-center justify-center">
          ...
          <div className=" text-center px-4 space-y-7">
            <h2 className="md:text-5xl text-4xl font-bold md:leading-snug leading-snug">
              Hazi marble, prized for{" "}
              <span className="text-green">beauty and patterns</span>
            </h2>
      ...
      <div className="section-container">
        <div className="flex flex-col md:flex-row flex-wrap md:justify-between items-center space-y-3 mb-8">
          ...
          <div className="bg-primary btn rounded-full font-bold text-white gap-4">
            <button
              onClick={showAll}
            ...
            <div className="bg-purple-500 btn rounded-full font-bold text-white gap-4">
            <button
              onClick={() => filterItems("offer")}
              className={selectedCategory === "offer" ? "active" : ""}
            >
              Offer
            </button>
            </div>
